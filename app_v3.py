...
POLL_RATE_HZ          = 20      # Stable 20Hz to prevent quantization noise
...
# Soft-Start PID gains tuned for 20Hz loop rate
KP = 0.0004
KI = 0.002
KD = 0.0
...
def run_scan(motor: MotorDriver, enc: EncoderReader, mic: Micrometer):
    ...
    # Use the longer scan stall time to give the PID a grace period to spool up
